...
<div class="card botcard" style="transform: translate(0px, 0px); opacity: 1;">
  <div class="card-body p-3 pb-2 botcard-hassplash" style="border-radius: 4px 4px 0px 0px; background: linear-gradient(rgba(48, 48, 48, 0.3) 50%, rgb(48, 48, 48) 98%), url(&quot;/assets/img/normal-card-bg.png&quot;);">
    <img class="cardimg" style="width:150px;height:150px; border-radius:50%;" alt="Bot Avatar" src="${bot.logo}" loading="lazy" draggable="false">
  </div>
  <div class="card-body pt-0 pb-0">
    ...
    <span class="text-danger mr-1">
      ...
      <a class="badge badge-secondary mb-1" style="margin-right:3px;">VERIFIED
      </a>
      <br>
      <br>
    ...
    <div class="card-body pt-0 pb-0">
      <h4 class="mb-0 text-center pt-1">
        <b>${bot.username}  
        </b>
      ...
      <p class="mb-2 text-center text-muted botdesc">${bot.description}
      </p>
    </div>
  </div>
  ...
  <div class="card-body pt-0 botcard-btnholder">
    <div class="btn-group btn-sm">
      <a class="btn btn-sm btn-secondary" style="width:50%;" href="/bots/like/${bot.botid}/">Vote Bot
      </a>
    </div>
    <div class="btn-group btn-sm">
      <a class="btn btn-sm btn-blue" style="width:50%;" href="/bots/${bot.botid}/">View Bot
      </a>
    </div>
    <div class="btn-group btn-sm">
      <a class="btn btn-sm btn-secondary" style="width:50%;" href="https://discord.com/oauth2/authorize?client_id=${bot.botid}&amp;scope=bot&amp;permissions=0"> Invite Bot
      </a>
    </div>
  </div>
</div>`
