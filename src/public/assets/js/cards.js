...
<div class="card botcard" style="transform: translate(0px, 0px); opacity: 1;">
    <div class="card-body p-3 pb-2 botcard-hassplash" style="border-radius: 4px 4px 0px 0px; background: linear-gradient(rgba(48, 48, 48, 0.3) 50%, rgb(48, 48, 48) 98%), url(&quot;/assets/img/normal-card-bg.png&quot;);"><img class="cardimg" style="width:150px;height:150px; border-radius:50%;" alt="Bot Avatar" src="${bot.logo}" loading="lazy" draggable="false" /></div>
    <div class="card-body pt-0 pb-0">
        <div class="w-100"></div><span class="text-danger mr-1"><i class="fas fa-badge-check"></i><a class="badge badge-secondary mb-1" style="margin-right:3px;">VERIFIED</a><br /><br />
            <div class="botcount mb-2 text-damp text-bold" data-toggle="tooltip" data-placement="left" title="" data-original-title="Votes This Month"><span class="float-left text-white h-100"><i class="fas fa-star pt-1 pb-1"></i></span>115</div>
            <div class="w-100"></div>
        </span>
        <div class="card-body pt-0 pb-0">
            <h4 class="mb-0 text-center pt-1"><b>${bot.username} </b><span class="VERIFIEDbadge" data-toggle="tooltip" title="" data-original-title="VERIFIED Bot"></span><span class="text-danger mr-1"><i class="fas fa-check-circle"></i></span></h4>
            <p class="mb-2 text-center text-muted botdesc">${bot.description}</p>
        </div>
    </div>
    <hr class="mt-1 mb-3 bg-secondary" />
    <div class="card-body pt-0 botcard-btnholder">
        <div class="btn-group btn-sm"><a class="btn btn-sm btn-secondary" style="width:50%;" href="/bots/like/792698780524740639/">Vote Bot</a></div>
