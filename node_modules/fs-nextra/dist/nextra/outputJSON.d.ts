 ...
 * @param atomic If the operation should be done atomically
 */
export default function outputJSON(file: string, data: any, atomic?: boolean): Promise<void>;
export default function outputJSON(file: string, data: any, options?: JsonOptions, atomic?: boolean): Promise<void>;
