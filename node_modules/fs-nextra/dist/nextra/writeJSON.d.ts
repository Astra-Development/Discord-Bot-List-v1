 ...
 * @returns {Promise<void>}
 */
export default function writeJSON(file: string, object: any, atomic?: boolean): Promise<void>;
export default function writeJSON(file: string, object: any, options?: JsonOptions, atomic?: boolean): Promise<void>;
