 ...
 * @param atomic Whether the operation should run atomically
 */
export default function createSymlink(source: string, destination: string, atomic?: boolean): Promise<void>;
export default function createSymlink(source: string, destination: string, type?: SymLinkType, atomic?: boolean): Promise<void>;
